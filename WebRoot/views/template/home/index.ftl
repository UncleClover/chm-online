	...
	<div id="wrapper">
    	<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="header-right">
                ...
                <a href="message-task.html" class="btn btn-primary" title="待办事项"><b>4&nbsp;</b><i class="fa fa-bars fa-2x"></i></a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="main-box mb-red">
                            <a href="javascript:void(0);"><i class="fa fa-bolt fa-5x"></i><h5>Zero Issues</h5></a>
                        </div>
                    </div>
                    <div class="col-md-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="javascript:void(0);">
                                                    <img class="media-object img-circle img-comments" src="img/user.png" />
                                                </a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media">
                                                        <a class="pull-left" href="javascript:void(0);">
                                                            <img class="media-object img-circle img-comments" src="img/user.gif" />
                                                        </a>
                                                        <div class="media-body">
