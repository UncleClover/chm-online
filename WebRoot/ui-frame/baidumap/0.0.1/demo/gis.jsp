...
<c:set var="mapRes" value="${_base}/resources/spm_modules/baidumap"/>
<!-- 建议通过配置中心获取nginx（外网）代理地址 -->
<c:set var="_proxyServerAddress" value="10.1.235.24:28080"/>
<script>
//此名称为固定_proxyServerAddress，以便apijs中能够获取
    var _proxyServerAddress = "${_proxyServerAddress}";
</script>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="stylesheet" href="${mapRes}/0.0.1/css/DrawingManager_min.css" />	
	<script type="text/javascript" src="${_base}/resources/spm_modules/jquery/1.9.1/jquery.min.js"></script>	
	<script type="text/javascript" src="${mapRes}/0.0.1/js/asc-ext-map-0.1.js"></script>
	<script type="text/javascript" src="${mapRes}/0.0.1/js/mapapi-2.0.min.js"></script>
	<script type="text/javascript" src="${mapRes}/0.0.1/js/DrawingManager_min.js"></script>
	<script type="text/javascript" src="${mapRes}/0.0.1/js/asc-ext-map-0.1.js"></script>
	<title>地图展示</title>
</head>
<body>
